...
import { Globe, MapPin, CheckCircle2, Loader2, User } from "lucide-react";
        ...
        <CardContent className="space-y-6 pt-6">
          ...
          <div className="pt-4 space-y-4">
            ...
            <p className="text-[10px] text-center text-muted-foreground px-4">
              {profile.location 
                ? "Your live location is shared with local contractors to help them find harvest routes."
                : "Sharing location helps contractors find your backyard trees more easily."}
            </p>
          </div>
